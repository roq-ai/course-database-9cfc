...
-- AddForeignKey
ALTER TABLE "course_file" ADD CONSTRAINT "course_file_organization_id_fkey" FOREIGN KEY ("organization_id") REFERENCES "organization"("id") ON DELETE NO ACTION ON UPDATE NO ACTION;
