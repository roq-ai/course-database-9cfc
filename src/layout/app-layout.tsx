...
import { FiMail, FiUsers, FiMenu, FiUser, FiMessageCircle, FiFile, FiBox, FiPhone, FiBriefcase } from 'react-icons/fi';
...
const SidebarContent = ({ onClose, ...rest }: SidebarProps) => {
  ...
  const tenantRoles = ['administrator', 'course-creator', 'team-member'];
  ...
  const LinkItems: Array<LinkItemProps> = [
    ...
    { name: 'Contact', path: '/contacts', entity: 'contact', service: AccessServiceEnum.PROJECT, icon: FiPhone },
    {
      name: 'Course File',
      path: '/course-files',
      entity: 'course_file',
