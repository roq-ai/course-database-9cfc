...
import { getCourseFileById } from 'apiSdk/course-files';
      ...
      <Box bg="white" p={4} rounded="md" shadow="md">
        <Flex justifyContent="space-between" mb={4}>
          <Text as="h1" fontSize="2xl" fontWeight="bold">
            Course File Detail View
          </Text>
          {hasAccess('course_file', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
            <NextLink href={`/course-files/edit/${data?.id}`} passHref legacyBehavior>
              <Button
